...
| File | Description |
|---|---|
| `kafka-cluster-sizer-v11.html` | Interactive calculator (v1.3 · April 2026) |
| `kafka-sizing-guide-review-v1.pdf` | Companion guide — walks through every variable and the math, written as a story not a spec sheet |
